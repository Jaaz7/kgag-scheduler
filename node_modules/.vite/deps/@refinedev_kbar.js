...
import {
  ...
  ro,
  wh
} from "./chunk-73QFQE7F.js";
import "./chunk-RZO2CY75.js";
import "./chunk-LAQOHMZS.js";
import {
  require_react_dom
...
var I = r(() => {
  let n = G(), { resource: e, resources: p, id: c, action: y } = O(), l = Z(), d = mt(), b = ge(), { mutate: H } = ro(), { push: K, list: Pt, create: wt, show: Tt, edit: kt } = ce(), V = at(), $ = (0, import_react3.useContext)(import_kbar3.KBarContext), { can: a } = wh(), [B, j] = (0, import_react3.useState)([]);
